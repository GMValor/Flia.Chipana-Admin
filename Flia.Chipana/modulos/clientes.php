...
<div class="module-container-clientes">

    <!-- HEADER -->
    <div class="module-header-clientes">
        <h2>CLIENTES</h2>
        <div class="search-add-clientes">
            <input type="text" placeholder="Buscar cliente" class="search-bar-clientes">
            <button class="btn-add-clientes">Agregar items</button>
        </div>
    </div>
    ...
    <table class="custom-table-clientes">
        <thead>
            <tr>
                <th>ID</th>
                <th>Nombre</th>
